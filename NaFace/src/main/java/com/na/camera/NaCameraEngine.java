...
public class NaCameraEngine implements INaCameraEngine,
    ...
    private int mPreviewWith = DEFAULT_WIDTH;
    private int mPreviewHeight = DEFAULT_HEIGHT;

    private int mPictureWidth = DEFAULT_WIDTH;
    private int mPictureHeight = DEFAULT_HEIGHT;
    ...
    private void startPreview(int width, int height, int framerate) {
        if (mCamera != null && width > 0 && height > 0 && framerate > 0) {
            ...
            mPreviewWith = captureFormat.width;
            mPreviewHeight = captureFormat.height;
            parameters.setPreviewSize(mPreviewWith, mPreviewHeight);
            ...
            if (pictureSize != null) {
                ...
                mPreviewHeight = pictureSize.height;
                parameters.setPictureSize(mPictureWidth, mPreviewHeight);
            }
