...
public class GlUtil {
    ...
    public static int createProgram(String vertexSource, String fragmentSource) {
        ...
        if (program == 0) {
            NaLog.e(TAG, "Could not create program");
        }
        ...
        if (linkStatus[0] != GLES20.GL_TRUE) {
            NaLog.e(TAG, "Could not link program: ");
            NaLog.e(TAG, GLES20.glGetProgramInfoLog(program));
            GLES20.glDeleteProgram(program);
            program = 0;
        }
        NaLog.i(TAG, "linkStatus:" + linkStatus[0]);
        return program;
    }
    ...
    public static int loadShader(int shaderType, String source) {
        ...
        if (compiled[0] == 0) {
            NaLog.e(TAG, "Could not compile shader " + shaderType + ":");
            NaLog.e(TAG, " " + GLES20.glGetShaderInfoLog(shader));
